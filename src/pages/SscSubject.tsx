    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <CardContent className="p-5">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-muted-foreground mt-0.5">Alphabet · Complementary pairs · Voice structure · Subject/Object · Parts of speech</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        {subject === 'reasoning' && (
          <Card
            className="cursor-pointer hover:shadow-md transition-shadow border-border hover:border-primary/30"
            onClick={() => navigate('/ssc/reasoning/practice')}
          >
            <CardContent className="p-5">
              <div className="flex items-start gap-3">
                <span className="text-3xl">⚡</span>
                <div className="flex-1 min-w-0">
                  <span className="inline-block text-[10px] font-semibold tracking-wider uppercase text-amber-700 bg-amber-100 px-2 py-0.5 rounded mb-1.5">New</span>
                  <h3 className="font-semibold text-foreground">Practice</h3>
                  <p className="text-sm text-muted-foreground mt-0.5">Alphabet visualiser (−1000 → 1000) + practice problems</p>
                </div>
              </div>
            </CardContent>
          </Card>
