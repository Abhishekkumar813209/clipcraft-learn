        ...
        <div className="text-center space-y-3">
          ...
          <div>
            ...
            <p className="text-sm text-white/50 mt-1">
              {forgotMode ? 'Reset your password' : isLogin ? 'Sign in to continue learning' : 'Create your study account'}
            </p>
          </div>
        </div>
          ...
          {forgotMode ? (
            <>
              ...
              <form onSubmit={handleForgotPassword} className="space-y-4">
                <div className="space-y-1.5">
                  <Label htmlFor="reset-email" className="text-xs text-white/50 font-medium">Email</Label>
                ...
                <Button type="submit" className="w-full h-11 font-semibold text-sm" disabled={resetLoading}>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {!isLogin && (
                  <div className="space-y-1.5">
                    <Label htmlFor="displayName" className="text-xs text-white/50 font-medium">Display Name</Label>
                    <div className="relative">
                      ...
                      <Input id="displayName" placeholder="Your name" value={displayName} onChange={(e) => setDisplayName(e.target.value)}
                        className="pl-9 h-11 bg-white/[0.04] border-white/10 text-white placeholder:text-white/25 focus-visible:ring-primary/50 focus-visible:border-primary/30" required={!isLogin} />
                    </div>
                  </div>
                )}
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input id="email" type="email" placeholder="you@example.com" value={email} onChange={(e) => setEmail(e.target.value)}
                      className="pl-9 h-11 bg-white/[0.04] border-white/10 text-white placeholder:text-white/25 focus-visible:ring-primary/50 focus-visible:border-primary/30" required />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input id="password" type={showPassword ? 'text' : 'password'} placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)}
                      className="pl-9 pr-10 h-11 bg-white/[0.04] border-white/10 text-white placeholder:text-white/25 focus-visible:ring-primary/50 focus-visible:border-primary/30" required minLength={6} />
